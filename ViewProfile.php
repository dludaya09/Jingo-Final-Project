...
$usr=$_SESSION['userid'];
$ID=(int)$usr;
$rslt="Select * from user where userid = '$ID'";
    ...
    <div id="header" class="container">
        ...
        <div id="menu">
            <ul>
                ...
                <li><a href="#edit" data-toggle="tab" id="edit" onClick="edit()">Edit Profile</a></li>
...
<div class="actions">
    ...
    <h3>Profile of <?php echo $_SESSION['userid']; ?></h3>

    <fieldset>
    <legend>User Profile</legend>
    <label for="userid">Userid:<?php echo $row['userid']; ?></label><br>
    <label for="username">User Name:<?php echo $row['username'];?></label><br>
    <label for="City">City:<?php echo $row['city']; ?></label><br>
    <label for="state">State:<?php echo $row['state']; ?></label><br>
    <label for="City">Country:<?php echo $row['country']; ?></label><br>
